    ...
    <aside class="sidebar">
        ...
        <nav>
            <ul class="sidebar-nav">
                ...
                <li><a href="officials.php" class="active"><i class="fas fa-user-tie"></i> Officials</a></li>
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions">
                                        <button class="btn btn-sm btn-info" onclick="editOfficial(<?= $o['id'] ?>)"><i class="fas fa-edit"></i></button>
