...
<div class="app">
    ...
    <main class="main-content">
        <div class="page-header">
            <div>
                <h1><i class="fas fa-file-alt"></i> Document Processing</h1>
                ...
                <table>
                    ...
                    <tbody>
                        <?php if (empty($requests)): ?>
                            <tr><td colspan="8"><div class="empty-state"><i class="fas fa-file-alt"></i><h3>No requests found</h3><p>Create a new document request to get started.</p></div></td></tr>
                        <?php else: ?>
